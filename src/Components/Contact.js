    ...
    <section className="bg-white w-screen dark:bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md relative"> {/* Added relative positioning */}
        ...
        <form onSubmit={handleSendMessage} className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" style={{ backgroundColor: '#d0ded8' }}>Send message</button>
        </form>
        {showNotification && (
