            ...
            <div className="Links">
                <ul className="flex py-7 px-5 m-5 font-semibold">
                    <li className="mx-2 md:mx-6 text-[10px] md:text-lg cursor-pointer">
                        <Link to="about" smooth={true} duration={500} onClick={scrollToAbout} >About Me</Link>
                    </li>
                    <li className="mx-2 md:mx-6 text-[10px] md:text-lg">Contact Me</li>
                    <li className="mx-2 md:mx-6 text-[10px] md:text-lg">Resume</li>
                </ul>
            </div>
        </div>
    );
